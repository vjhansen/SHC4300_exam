...
sw[2:0] selects which RAM-block to store a certain tune. It is 3 bits such that the user can store up to 8 songs. The 3 bits are the first bits (MSB) og the RAM address, and the remaining 8 bits will be the ASCII code/note.

<img src="/Resources/images/w5d1_data.png" alt="drawing" width="600"/>
